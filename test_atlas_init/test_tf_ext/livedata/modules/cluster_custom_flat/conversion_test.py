...
def test_instance_size_found_on_existing(input_dict):
    ...
    assert resource.get_instance_size(0, 0, "electable") == "M10"  # from the old cluster
    assert resource.get_instance_size(99, 99, "electable") == default_instance_size
...
def test_instance_size_no_existing_uses_compute_min_size(input_dict):
    ...
    assert resource.get_instance_size(0, 0, "electable") == "M30"
